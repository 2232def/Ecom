...
function Popup({ visible, onClose, handleClick, item, size, warning,cart ,setCart}) {
    ...
    <section className="w-full h-screen fixed top-0 left-0 backdrop-blur-sm">
      ...
      <div className="w-[90vw] h-[80vh] bg-white fixed bottom-0  rounded-md translate-x-20 overscroll-auto">
        ...
        <div className="w-full h-full bg-red-400 overflow-auto flex">
          <div className="">
            <div className="w-[80vh] h-[80vh] m-9 bg-red-200 rounded-md"><img className="h-full object-fill" src={item.imageSrc} alt="" /></div>
      ...
      <Cart visible={showCart} item={item} cart={cart} setCart={setCart} onClose={handleOnClose}/>
    </section>
  );
}
